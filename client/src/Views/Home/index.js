    ...
    if (!email) {
      ...
      try {
        const response = await Axios.post(
          'http://localhost:3001/enviarCorreo/enviar-soporte',
          {
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <form>
                <div className="mb-3">
                  <label htmlFor="TextInputEmail" className="col-form-label">
                ...
                <div className="mb-3">
                  <label htmlFor="tipoProblema" className="col-form-label">
                    Tipo de problema:
                  </label>
                  <select
                    className="form-control"
                ...
                <div className="mb-3">
                  <label htmlFor="problemDescription" className="col-form-label">
                    Mensaje:
                  </label>
                  <textarea
                    className="form-control"
