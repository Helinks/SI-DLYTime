      ...
      <div class="barEmpleado">
        <div class="bg-danger p-4">
          <div class="optionsEmpleado">
            <Link to="/CrudClientes_Empleado" className="btn btn-outline-light"><svg xmlns="http://www.w3.org/2000/svg" width="150" height="150" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
