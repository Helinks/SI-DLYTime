        ...
        <nav className="navbar navbar-dark bg-danger">
          <div className="container-fluid d-flex justify-content-between align-items-center">
            <div className="navbar-brand">
              <h2>Tus lentes shop</h2>
            </div>
            <div className="d-flex">
              <Link to="/Login" className="nav-link text-white mx-2">Iniciar sesión</Link>
              <Link to="/Soporte" className="nav-link text-white mx-2">Soporte</Link>
              <Link to="/AcercaDe" className="nav-link text-white mx-2">Acerca de</Link>
            </div>
          </div>
        </nav>
      </div>
