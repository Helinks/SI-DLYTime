      ...
      <div class="barCliente">
        <div class="bg-danger p-4">
          <div class="optionsCliente">
            ...
            <Link to="/soporte" class="btn btn-outline-light"><svg xmlns="http://www.w3.org/2000/svg" width="150" height="150" fill="currentColor" class="bi bi-person-raised-hand" viewBox="0 0 16 16">
