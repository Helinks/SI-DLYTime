            ...
            <div className="modal-dialog">
              <div className="modal-content">
                  ...
                  <form>
                    ...
                    <div className="mb-3">
                      ...
                      <select className="form-select" id="tipoConsulta" name="tipoConsulta">
                        <option value="Lentes y Monturas">Tipo de Consulta</option>
                ...
                <div className="modal-footer">
                  ...
                  <button type="button" className="btn1">Guardar Cambios</button>
                </div>
              </div>
            </div>
          </div>
