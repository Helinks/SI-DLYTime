...
<nav class="navbarUsers navbar-dark bg-danger">
      ...
      <div class="welcomeEmpleado"><h1>Bienvenido <i><b>{persona[2].nombre}</b></i></h1></div>
      <div class="barEmpleado">
        <div class="bg-danger p-4">
          <div class="optionsEmpleado">
            <Link to="/EmpleadoAdClientes" className="btn btn-outline-light"><svg xmlns="http://www.w3.org/2000/svg" width="150" height="150" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
