...
function Perfil() {
  ...
  const getUser = useCallback( async () => {
    Axios.get("https://backenddlytime-efgpffakcxe2d9e9.brazilsouth-01.azurewebsites.net/perfil/datosUsuario", {
      params: { id: id }
    }).then((datosUser) => {
  ...
  const editarUsuario = () => {
    Axios.patch("https://backenddlytime-efgpffakcxe2d9e9.brazilsouth-01.azurewebsites.net/Perfil/updateUsuario", {
      numeroDocumento: id,
      nombre: nombre,
      password: password,
      apellido: apellido,
  ...
  const editarUsuarioAdmin = () => {
    Axios.patch("https://backenddlytime-efgpffakcxe2d9e9.brazilsouth-01.azurewebsites.net/Perfil/updateUsuarioAdmin", {
      numeroDocumento: id,
      password: password,
