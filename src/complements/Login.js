...
function Login() {
  ...
  const consulta = (e) => {
    ...
    Axios.post("https://backenddlytime-efgpffakcxe2d9e9.brazilsouth-01.azurewebsites.net/autenticacion/login", {
      correo_i: correo_i,
  ...
  const handleForgotPasswordSubmit = async (e) => {
    ...
    try {
      ...
      await Axios.post("https://backenddlytime-efgpffakcxe2d9e9.brazilsouth-01.azurewebsites.net/enviarCorreo/enviarCorreoPassword", {
        to: forgotEmail,
  ...
  const validarCodigo = async () => {
    try {
      const response = await Axios.post(
        "https://backenddlytime-efgpffakcxe2d9e9.brazilsouth-01.azurewebsites.net/recuperarPassword/validarCodigo",
        {
          correo: forgotEmail,
          code: codigoV,
        });
  ...
  const restablecer = async () => {
    ...
    await Axios.patch("https://backenddlytime-efgpffakcxe2d9e9.brazilsouth-01.azurewebsites.net/recuperarPassword/cambiarPassword", {
      correo: forgotEmail,
      password: password,
      codigo: codigoV,
    }).then((response) => {
