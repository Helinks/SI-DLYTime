...
function CrudCita() {
  ...
  const searchFilter = useCallback(async () => {
    ...
    try {
      const response = await Axios.get(`https://backenddlytime-efgpffakcxe2d9e9.brazilsouth-01.azurewebsites.net/crudCitas/crudCita`, {
        params: {
          q: search,
          fecha: fechaFilter,
  ...
  const addCita = () => {
    ...
    Axios.post("https://backenddlytime-efgpffakcxe2d9e9.brazilsouth-01.azurewebsites.net/crudCitas/addCita", {
      idHorario: idHorario,
  ...
  const getHorario = (fecha) => {
    ...
    Axios.get("https://backenddlytime-efgpffakcxe2d9e9.brazilsouth-01.azurewebsites.net/crudCitas/getHorarios", {
      params: { fecha: fecha },
    })
      .then((horario) => {
  ...
  const getConsultas = () => {
    Axios.get("https://backenddlytime-efgpffakcxe2d9e9.brazilsouth-01.azurewebsites.net/crudCitas/getTipoConsulta", {})
      .then((response) => {
  ...
  const getEmpleado = () => {
    Axios.get("https://backenddlytime-efgpffakcxe2d9e9.brazilsouth-01.azurewebsites.net/crudCitas/getEmpleados", {})
      .then((empleado) => {
  ...
  const getCliente = useCallback((cliente) => {
    ...
    Axios.get("https://backenddlytime-efgpffakcxe2d9e9.brazilsouth-01.azurewebsites.net/crudCitas/getClientes", {
  ...
  const changeEstado = (id,identificadorHorario,idEstado,idEstadoH) => {
    ...
    Axios.patch("https://backenddlytime-efgpffakcxe2d9e9.brazilsouth-01.azurewebsites.net/crudCitas/cancelCita", {
      idCita:id,
  ...
  const updateCita = (id,idEstadoH,idHorario1) => {
    ...
    Axios.patch("https://backenddlytime-efgpffakcxe2d9e9.brazilsouth-01.azurewebsites.net/crudCitas/updateCita", {
      idCita: id,
