...
function CrudClientes() {
  ...
  const getClientes = () => {
    Axios.get("https://backenddlytime-efgpffakcxe2d9e9.brazilsouth-01.azurewebsites.net/crudClientes/consultaCliente")
      .then((response) => {
  ...
  const abrirHistorialModal = (numeroDocumento) => {
    ...
    setHistorialClinico([]);
    Axios.get(`https://backenddlytime-efgpffakcxe2d9e9.brazilsouth-01.azurewebsites.net/crudClientes/consultaHistorialClinico/${numeroDocumento}`)
      .then((response) => {
  ...
  const guardarPDF = () => {
    ...
    // Subir PDF
    Axios.post("https://backenddlytime-efgpffakcxe2d9e9.brazilsouth-01.azurewebsites.net/crudClientes/agregarHistorialClinico", formDataPDF, {
      headers: {
                ...
                {historialClinico.map((item, i) => (
                  <tr key={i}>
                    ...
                    <td>
                      ...
                      <a
                        href={`https://backenddlytime-efgpffakcxe2d9e9.brazilsouth-01.azurewebsites.net/uploads/${item.archivoPDF}`}
                        target="_blank"
                        rel="noreferrer"
